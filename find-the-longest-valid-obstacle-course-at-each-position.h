...
// Runtime: 232 ms, faster than 100.00% of C++ online submissions for Find the Longest Valid Obstacle Course at Each Position.
...
public:
    ...
    vector<int> longestObstacleCourseAtEachPosition(vector<int> &obstacles)
    {
        ...
        for (auto obs : obstacles)
        {
            ...
            // Binary search to find longest sequence till now
            while (l < r)
            {
                int m = (l + r) / 2;
                if (sub[m] > obs)
